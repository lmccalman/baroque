...
def create_latex_document(pages: list[tuple[Path, Path, Path]], output_path: Path, notebook_title: str, model_name: str, summary: str):
    """
...
\\begin{{titlepage}}
    ...
    \\vspace{{1cm}}
    {{\\Large Generated by {MODEL_NAMES[model_name]}\\par}}
    \\vspace{{1cm}}
    {{\\large \\today\\par}}
    \\vspace*{{\\fill}}
\\end{{titlepage}}
